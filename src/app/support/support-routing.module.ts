    ...
    path: '', component: SupportMainComponent, children: [
      {
        path: SUPPORT_ROUTE_URLS.ABOUT_GM, component: AboutGoodMobileComponent, data: {
          title: 'GoodMobile | About GoodMobile',
      ...
      },
      {
        path: SUPPORT_ROUTE_URLS.CONTACT_US, component: ContactUsComponent, data: {
          title: 'GoodMobile | Support | Contact Us',
      ...
      { path: SUPPORT_ROUTE_URLS.DATA_SETUP, component: DataSetupComponent , data: {
        title: 'Data Setup',
        description: 'Learn how to setup data services for your iPhone or Androind cell phones on the GoodMobile wireless network.'
      } as IPageMeta},
      { path: SUPPORT_ROUTE_URLS.IPHONE, component: IosGsmComponent , data: {
        title: 'Data Setup | IPhone',
        description: 'Learn how to setup data services for your iPhone cell phones on the GoodMobile wireless network.'
      } as IPageMeta},
      ...
      { path: SUPPORT_ROUTE_URLS.IPHONE4G, component: IosFourthGenerationPageComponent , data: {
        ...
        description: 'Fourth Generation for 4G Iphone GoodMobile network.'
      } as IPageMeta},
      { path: SUPPORT_ROUTE_URLS.IPHONE5G, component: IosFifthGenerationPageComponent , data: {
        title: 'Data Setup | IPhone | 5G',
        description: 'Fifth Generation for 5G Iphone GoodMobile network.'
      } as IPageMeta},
      { path: SUPPORT_ROUTE_URLS.TMO_Android, component: TMobileComponent , data: {
        title: 'Data Setup | Android',
        description: 'Learn how to setup data services for your Android cell phones on the GoodMobile wireless network.'
      } as IPageMeta},
      ...
      { path: SUPPORT_ROUTE_URLS.ANDROID4G, component: FourthGenerationPageComponent , data: {
        ...
        description: 'Fourth Generation for 4G Android GoodMobile network.'
      } as IPageMeta},
      { path: SUPPORT_ROUTE_URLS.ANDROID5G, component: FifthGenerationPageComponent , data: {
        title: 'Data Setup | Android | 5G',
        description: 'Fifth Generation for 5G Android GoodMobile network.'
      } as IPageMeta},
      ...
      { path: SUPPORT_ROUTE_URLS.SUPPORT_CATEGORY, component: SupportComponent, data: { title: 'Support FAQs', description: 'We understand - when small things do not work... you just want an answer. Here are some Frequently Asked Questions.' } as IPageMeta },
      {
        ...
        data: { title: 'GoodMobile | Support | Hearing Aid Compatibility', description: 'Learn about GoodMobile Hearing Aid Compatibility.' } as IPageMeta
      },
      {
        path: SUPPORT_ROUTE_URLS.HOW_IT_WORKS, component: HowItWorksComponent, data: {
          title: 'GoodMobile| How It Works', description:
            'With GoodMobile there are no contracts. We are powered by a premium carrier* that boasts the best 4G LTE network in the United States.'
        } as IPageMeta
      },
      {
        path: SUPPORT_ROUTE_URLS.INTERNATIONAL_CALLING, component: InternationalCallingComponent, data: {
          ...
          description: 'GoodMobile International plans offer unlimited talk and text to over 60 countries including Canada and Mexico for just $5 a month.'
        } as IPageMeta
      },
      {
        path: SUPPORT_ROUTE_URLS.LANDING_COVERAGE, component: LandingCoverageComponent, data: {
          title: 'GoodMobile Coverage',
          description: 'Check if GoodMobile wireless service has coverage in your area using our cell phone service coverage map. Enter your address or zip code to see coverage zones.'
        } as IPageMeta
      },
        ...
        { title: 'GoodMobile Sitemap', description: 'Access all links available in GoodMobile easily' } as IPageMeta },
      {
        path: SUPPORT_ROUTE_URLS.STORE_LOCATOR, component: StoreLocatorComponent, data: {
          title: 'GoodMobile | Support | Store Locator',
          description: 'Find GoodMobile authorized retailers near you.'
        } as IPageMeta
      },
      {path: SUPPORT_ROUTE_URLS.WHY_GM, component: WhyGoodMobileComponent, data: {title: 'GoodMobile | Why GoodMobile?', description:
