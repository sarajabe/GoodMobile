...
fdescribe('Yes flow - EBB Address Info Component - Unit Testing', async () => {
  beforeEach(async () => {
  ...
  it('Should check that the address is not empty when there is a primary address already sent from main component', waitForAsync(() => {
    fixture.whenStable().then(() => {
