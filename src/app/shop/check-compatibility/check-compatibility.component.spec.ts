...
import { CheckCompatibilityComponent } from './check-compatibility.component';

let component: CheckCompatibilityComponent;
let fixture: ComponentFixture<CheckCompatibilityComponent>;

let mockMobileCustomPlansService;
let mockMobileCustomPlansService2;
...
describe('Check Compatibility - Unit Test', async () => {
    const PLAN_OBJECT = { plan: true };
    ...
    beforeEach(async () => {
        ...
        mockMobileCustomPlansService2 = jasmine.createSpyObj(['MobileCustomPlansService', 'currentPlan']);
        await TestBed.configureTestingModule({
            declarations: [CheckCompatibilityComponent,
        ...
        TestBed.overrideProvider(MobileCustomPlansService, { useValue: mockMobileCustomPlansService2 });
        TestBed.compileComponents();
    });
    beforeEach(async () => {
        fixture = TestBed.createComponent(CheckCompatibilityComponent);
        component = fixture.componentInstance;
        spyOn(component.router, 'navigate');
        mockSimpleAuthService.userState.and.returnValue(AUTH_STATE_OBJECT);
        mockSimpleAuthService.userState = of(true);

        mockMobileCustomPlansService.currentPlan.and.returnValue(PLAN_OBJECT);
        ...
        mockMobileCustomPlansService2.currentPlan.and.returnValue(CART_OBJECT);
        mockMobileCustomPlansService2.currentPlan = of(true);
