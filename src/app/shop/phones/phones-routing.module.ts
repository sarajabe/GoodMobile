...
const routes: Routes = [{
  ...
  children: [
    {path: PHONES_SHOP_ROUTE_URLS.TYPE, component: TypeComponent, data: {title: 'Best Refurbished iPhones | Good Mobile', description:
    ...
    {path: PHONES_SHOP_ROUTE_URLS.DETAILS, component: DetailsComponent, data: {title: 'Buy Refurbished iPhone | Free SIM | Good Mobile', description:
