...
describe('Select plan as new user - shipping address assertions - required and invalid validation messages', () => {
    before(() => {
    ...
    it('should fill in valid payment info', () => {
    ...
    it('should click on add another card so we close the payment info form', () => {
