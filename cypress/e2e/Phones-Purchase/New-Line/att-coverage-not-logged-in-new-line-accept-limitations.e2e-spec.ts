...
describe('Purchase a phone - new line - att coverage - not logged in - check the yes checkbox for accepting limitations and complete checkout with ATT coverage', () => {
    before(() => {
