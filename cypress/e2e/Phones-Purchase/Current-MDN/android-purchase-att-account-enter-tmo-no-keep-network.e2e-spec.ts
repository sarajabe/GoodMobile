...
describe('Purchase an android - user with att mdn - enter tmo zip - no do not change network', () => {
    before(() => {
    ...
    it('Should click on shop phones btn for pixel phones', () => {
    ...
    it('Should select 2nd phone', () => {
        PageObjects.PurchasedPhones.clickOnSelect2ndAndroidPhone();
    });
