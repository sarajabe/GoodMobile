...
/** activate plan from purchased plans page - 
 * plan was purchased and the compativility was skipped 
 * imei not saved **/


describe('activate plan - imei not saved', () => {
    before(() => {
   ...
   it('Should select phone btn', () => {
    ...
    it('Should click on continue btn from the pop up', () => {
        PageObjects.Compatibility.clickOnContinueButton();
    });
