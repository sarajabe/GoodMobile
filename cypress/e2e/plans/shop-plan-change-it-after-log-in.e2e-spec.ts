...
describe('Select new plan with a full cart - change it after logging in', () => {
    before(() => {
   ...
   it('Should insert valid info for existing customer', () => {
        PageObjects.AccessControl.existingCustomerLogin(CONSTANT.ACCESS.EMPTY_PLANS_USER.EMAIL, CONSTANT.ACCESS.EMPTY_PLANS_USER.PASSWORD);
   });
