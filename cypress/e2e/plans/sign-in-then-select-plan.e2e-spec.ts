...
/* ********************************* */
/* Sign in , select plan , click on i have a phone , then check compatibility
 , complete checkout
 make sure when you run this test to make the cart empty
 */
/* ********************************* */

describe('Sign in then select plan', () => {
     before(() => {
