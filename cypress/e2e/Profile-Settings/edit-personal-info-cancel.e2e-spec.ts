...
describe('Sign in then go to profile settings and edit the personal information and cancel the changes', () => {
     before(() => {
     ...
     it('Should click on cancel changes button', () => {
          PageObjects.ProfileSettings.clickOnCanCelNameChange();
     });
     ...
     it('Should click on save changes button', () => {
          PageObjects.ProfileSettings.clickOnCancelEmailChange();
     });
});
