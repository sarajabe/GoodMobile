...
describe('Sign in then enroll in ACP plan - new user - invalid phone number', () => {
    before(() => {
    ...
    it('Should go to acp - step 3 to fill in the physical address', () => {
        PageObjects.TitleExpectations.goToACPEnrollemntPage();
    });
    ...
    it(`Should assert the validation pop up  and click on got it btn from pop up`, () => {
        cy.get('.modal-content > :nth-child(1) > .ng-star-inserted > :nth-child(3)').should('have.text','1111111111');
