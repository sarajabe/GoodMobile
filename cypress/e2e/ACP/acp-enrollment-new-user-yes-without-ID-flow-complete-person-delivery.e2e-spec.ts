...
describe('Signup then enroll in ACP plan - new user - yes without ID flow - complete - pesron delivery', () => {
    before(() => {
    ...
    it('Should purchase ACP plan with pesron delivery then activate', () =>{
        PageObjects.Acp.addNewLinePesronDeliveryActivateYesWithoutIDFlow();  
    });
});