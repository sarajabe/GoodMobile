...
describe('Sign in then enroll in ACP plan with not capitalised initials in the signature page', () => {
    before(() => {
    ...
    it(`Should fill in signutures with small letter initials`, () => {
        PageObjects.Acp.notCapitalisedInitials();
