...
describe('Sign in then enroll in ACP plan with empty fields of the signatre and then click on verify btn', () => {
    before(() => {
    ...
    it(`Should check the validation msg about the required initials`, () => {
        cy.get('.validation-message').should('have.text', ' Initials are required , please make sure you filled all of them Please verify that you are not a robot');
    });
    it('Should check the reCaptcha', () => {
        PageObjects.Recaptcha.checkRecaptchaCustomerInfo1();
    ...
    it(`Should check the validation msg about the required initials`, () => {
        cy.get('.validation-message').should('have.text', ' Initials are required , please make sure you filled all of them ');
    });
});
