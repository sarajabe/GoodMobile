...
describe('Sign in then go to account summary to change pin and enter short current pin', () => {
    before(() => {
    ...
    it('Should insert SHORT pin number', () => {
    ...
    it('Should validate the length warning message', () => {
        cy.get('[data-cy="lengthWarningMessage"]').should('have.text', 'Account Pin Code minimum length is 4 digits');
    });
});
