...
describe('Lets Talk as a Order Support :', () => {
     before(() => {
     ...
     it('Should choose Order Support option successfully', () => {
          PageObjects.Contact.clickOnOrderSupportOption();
     });
     it('Should insert all the information successfully', () => {
          PageObjects.Contact.contactNC(CONSTANT.CONTACT_US.LETS_TALK_DATA.VALID2.NAME,
               CONSTANT.CONTACT_US.LETS_TALK_DATA.VALID2.EMAIL,
               CONSTANT.CONTACT_US.LETS_TALK_DATA.VALID2.PHONE_NUMBER,
               CONSTANT.CONTACT_US.LETS_TALK_DATA.VALID2.MESSAGE);
     });
