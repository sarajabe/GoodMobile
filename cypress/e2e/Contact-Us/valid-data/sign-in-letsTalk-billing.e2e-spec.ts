...
describe('Sign In & Lets Talk as a Billing :', () => {
     ...
     it('Should insert the message successfully because its required', () => {
          PageObjects.Contact.contactExistingCustomer(CONSTANT.CONTACT_US.LETS_TALK_DATA.VALID.MESSAGE);
     });
