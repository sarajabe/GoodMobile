...
class Acp {
     ...
     enrollmentNewUserAcpPendingReview(){
          ...
          this.clickOnNextBtn();
          this.invalidMessagesAcpSecondPage();
          this.fillInPhysicalAddressInfo(CONSTANT.ACP_DATA.PERSONAL_INFO_PENDING_RESOLUTION.ADDRESS1,
               CONSTANT.ACP_DATA.PERSONAL_INFO_PENDING_RESOLUTION.CITY);
          this.fillInPhysicalAddressInfo2(
               CONSTANT.ACP_DATA.PERSONAL_INFO_PENDING_RESOLUTION.STATE,
               CONSTANT.ACP_DATA.PERSONAL_INFO_PENDING_RESOLUTION.ZIP_CODE);
          cy.get('[data-cy="useSameAddress"]').click();
          this.clickOnNextBtn();
          PageObjects.TitleExpectations.goToACPEnrollemntPage();
